...
public class PropertiesManager {
    ...
    public void saveProperties() throws IOException{
        ...
        pw.println("");
        pw.println("");            
        pw.println("#externalport - port number used by clients to contact this server.");
        pw.println("#Always make sure that this port is opened in your firewall.");
        pw.println("externalport = " + props.getProperty("externalport"));
        pw.println("");
        pw.println("");
        pw.println("#internalport - port number used by the cluster.");
        pw.println("#Always make sure that this port is opened in your firewall.");
        pw.println("internalport = " + props.getProperty("internalport"));
        pw.println("");
        pw.println("");
    ...
    private void setConfigFile(){
        try{
            ...
            pw.println("#externalport - port number used by clients to contact this server.");
            pw.println("#Always make sure that this port is opened in your firewall.");
            pw.println("externalport = 8999");
            pw.println("");
            pw.println("");
            pw.println("#internalport - port number used by the cluster.");
            pw.println("#Always make sure that this port is opened in your firewall.");
            pw.println("internalport = 8989");
            pw.println("");
            pw.println("");
            pw.println("#autoclean - True if the server should be able to initiate");
            pw.println("#cleaning when errors are found and false if it has to be");
